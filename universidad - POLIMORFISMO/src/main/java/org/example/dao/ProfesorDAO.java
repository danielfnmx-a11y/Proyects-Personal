...
public class ProfesorDAO {
    ...
    public boolean nuevoProfesor(Profesor profesor){
        ...
        String sql = "INSERT INTO profesores (dniProfesor, nombreProfesor, curp, edadProfesor, especialidad, direccionProfesor, antiguedadProfesor) VALUES (?,?,?,?,?,?,?)";
        ...
        try(Connection conexion = Conexion.conectar();
            ...
            stm.setInt(4, profesor.getEdadProfesor());
            stm.setString(5, profesor.getEspecialidad());
            stm.setString(6, profesor.getDireccionProfesor());
            stm.setInt(7, profesor.getAntiguedadProfesor());
    ...
    public boolean actualizarProfesor(Profesor profesor){
        ...
        String sql =
                "UPDATE profesores SET nombreProfesor = ?, curp = ?, edadProfesor = ?, especialidad = ?, direccionProfesor = ?, antiguedadProfesor = ? WHERE dniProfesor = ?";
        ...
        try(Connection conexion = Conexion.conectar();
            ...
            stm.setInt(7, profesor.getDniProfesor());
